export default {
    textContents: {
        ...
        paragraphSections: [
            {aboveMapText: "Early USGS streamgages were distributed widely across the landscape, while an increasing fraction of newer gages have been concentrated in urban areas. A combination of urban growth, evolving local needs, and advances in monitoring technology have resulted in a shift of the proportion of urban gages in the U.S. A conservative estimate suggests in 1967, 16% of gages would have been considered urban (see <a href='#methods-anchor'>methods details</a>), compared to the 23% of USGS gages located within urban areas in 2018."
            },
