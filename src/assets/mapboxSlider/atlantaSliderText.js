export default {
    textContents: {
        ...
        introText: "",
        caption: 'Figure 2. An interactive slider map depicting the change in <span id="urbanGage" class="legendDot"></span> urban and <span id="ruralGage" class="legendDot"></span> non-urban stream gages and the growth of <span id="urbanPolygon"/></span> extent between 1967 and 2018 in north central Georgia.',
        paragraphSections: [
            {aboveSliderText: "Up to the 1960’s, the US invested in a wide geographic dispersal of gages, " + 
                            ...
                            "Cities grew enormously in the following decades.  Populations increased, as did the imperviousness " +  
            ...
            {belowSliderText: "As the creation of new dams slowed significantly after the 1960’s, some hydropower-oriented gages " +
